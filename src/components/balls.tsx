...
const SvgBalls = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M9.215 2s-.138 2.356 1.357 5.19c.457.869.956 1.569 1.428 2.123M3 5.928s1.933 1.047 3.428 3.881C7.923 12.644 7.785 15 7.785 15M12.5 17.5l5-5M15.5 12.5l2 2M12.5 15.5l2 2M14 14l2 2" />
    </svg>
  );
};
