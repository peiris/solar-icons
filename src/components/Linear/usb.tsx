...
const SvgUsb = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M11.25 18a.75.75 0 0 0 1.5 0h-1.5ZM12 2l.624-.416a.75.75 0 0 0-1.248 0L12 2Zm1.376 3.416a.75.75 0 1 0 1.248-.832l-1.248.832Zm-4-.832a.75.75 0 0 0 1.248.832l-1.248-.832Zm2-2.168 2 3 1.248-.832-2-3-1.248.832Zm0-.832-2 3 1.248.832 2-3-1.248-.832ZM12.75 18v-3h-1.5v3h1.5Zm0-3V2h-1.5v13h1.5Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
