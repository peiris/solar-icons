  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M18 18.5c0-1.404 0-2.107-.337-2.611a1.999 1.999 0 0 0-.552-.552C16.607 15 15.904 15 14.5 15h-5c-1.404 0-2.107 0-2.611.337a2 2 0 0 0-.552.552C6 16.393 6 17.096 6 18.5M6 11.5h12M6 9h12"
      />
    </svg>
  );
};
