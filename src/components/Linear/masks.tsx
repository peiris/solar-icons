...
const SvgMasks = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M11.096 7.042a.75.75 0 1 1-1.22-.872l1.22.872Zm.903-.29c-.378-.1-.73.048-.903.29l-1.22-.872c.55-.77 1.553-1.123 2.512-.866l-.389 1.449Zm.479.313a.894.894 0 0 0-.479-.312l.389-1.45c.524.141.966.445 1.275.843l-1.185.92Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
