...
const SvgInboxOut = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path d="M17 2.127c1.625.16 2.72.521 3.535 1.338C22 4.929 22 7.286 22 12s0 7.071-1.465 8.536C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.464C2 19.07 2 16.714 2 12c0-4.714 0-7.07 1.464-8.535.817-.817 1.91-1.178 3.536-1.338M12 10V2m0 0 3 3m-3-3L9 5" />
