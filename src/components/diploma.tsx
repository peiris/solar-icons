...
const SvgDiploma = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M17.32 17.996c1.972-.021 3.072-.145 3.801-.875C22 16.243 22 14.828 22 12V8c0-2.828 0-4.243-.879-5.121C20.243 2 18.828 2 16 2H8c-2.828 0-4.243 0-5.121.879C2 3.757 2 5.172 2 8v4c0 2.828 0 4.243.879 5.121.768.769 1.946.865 4.121.877M9 6h6M7 9.5h10" />
    </svg>
  );
};
