...
const SvgSuitcaseTag = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M10 15H6c-.471 0-.707 0-.854.146C5 15.293 5 15.53 5 16v1c0 .471 0 .707.146.854C5.293 18 5.53 18 6 18h4c.471 0 .707 0 .854-.146C11 17.707 11 17.47 11 17v-1c0-.471 0-.707-.146-.854C10.707 15 10.47 15 10 15ZM6 6.5V15m0 6.5v-3M18 6.5v15" />
    </svg>
  );
};
