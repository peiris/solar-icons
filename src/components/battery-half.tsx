...
const SvgBatteryHalf = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M7 9s.5.9.5 3-.5 3-.5 3M10.5 9s.5.9.5 3-.5 3-.5 3M20 10c.943 0 1.414 0 1.707.293.293.293.293.764.293 1.707 0 .943 0 1.414-.293 1.707C21.414 14 20.943 14 20 14v-4Z" />
    </svg>
  );
};
