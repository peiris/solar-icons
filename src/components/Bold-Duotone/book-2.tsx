...
const SvgBook2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="#1C274D"
        d="M20 18H7.426c-1.084 0-1.462.006-1.753.068-.513.11-.96.347-1.285.667-.11.108-.164.161-.291.505-.127.343-.107.489-.066.78l.022.15c.11.653.31.998.616 1.244.307.246.737.407 1.55.494.837.09 1.946.092 3.536.092h4.43c1.59 0 2.7-.001 3.536-.092.813-.087 1.243-.248 1.55-.494.2-.16.354-.362.467-.664H8a.75.75 0 0 1 0-1.5h11.975c.018-.363.023-.776.025-1.25ZM7.25 7A.75.75 0 0 1 8 6.25h8a.75.75 0 0 1 0 1.5H8A.75.75 0 0 1 7.25 7ZM8 9.75a.75.75 0 0 0 0 1.5h5a.75.75 0 0 0 0-1.5H8Z"
      />
    </svg>
  );
};
