...
const SvgColourTuneing = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7.913 8.717a3.811 3.811 0 0 1 .834-1.483c.36-.383.65-.484.776-.484.305 0 .716.178 1.09 1.016.379.849.637 2.228.637 4.234 0 2.099.265 3.72.767 4.845.507 1.135 1.335 1.905 2.46 1.905.724 0 1.384-.441 1.868-.955a5.308 5.308 0 0 0 1.178-2.078.75.75 0 1 0-1.436-.434 3.812 3.812 0 0 1-.834 1.483c-.36.383-.65.484-.776.484-.305 0-.716-.178-1.09-1.016-.379-.849-.637-2.228-.637-4.234 0-2.099-.265-3.72-.767-4.845-.507-1.135-1.335-1.905-2.46-1.905-.724 0-1.384.441-1.868.955a5.308 5.308 0 0 0-1.178 2.078.75.75 0 0 0 1.436.434Z"
      />
      <path
        fill="currentColor"
        d="M6 11.25a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5H6ZM14.5 11.25a.75.75 0 0 0 0 1.5H18a.75.75 0 0 0 0-1.5h-3.5Z"
      />
    </svg>
  );
};
