...
const SvgPills = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m20.408 8.718-1.953-1.952-.003.008c-.09.28-.235.672-.462 1.143-.454.943-1.236 2.201-2.554 3.52-1.318 1.318-2.577 2.1-3.52 2.554a8.868 8.868 0 0 1-1.143.461l-.007.003 1.953 1.952a5.437 5.437 0 1 0 7.688-7.689Z"
      />
      <path
        fill="currentColor"
        d="M6.717 10.138c.234.409.526.794.875 1.144l5.127 5.126c.349.35.734.641 1.143.876a5.99 5.99 0 0 1-1.62 2.959 6 6 0 1 1-5.526-10.105Z"
        opacity={0.3}
      />
    </svg>
  );
