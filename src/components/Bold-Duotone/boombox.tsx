...
const SvgBoombox = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7.25 13.095A3.001 3.001 0 0 0 8 19a3 3 0 0 0 .75-5.905V15a.75.75 0 0 1-1.5 0v-1.905ZM13.879 18.121a3 3 0 0 0 4.706-3.645l-1.348 1.347a.75.75 0 0 1-1.06-1.06l1.347-1.348a3.001 3.001 0 0 0-3.645 4.706Z"
      />
    </svg>
  );
};
