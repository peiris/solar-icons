...
const SvgEmojiFunnySquare = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M6.504 21.52c1.633.943 3.706.387 7.853-.724 4.147-1.11 6.22-1.666 7.163-3.3.943-1.633.387-3.706-.724-7.853-1.11-4.147-1.666-6.22-3.3-7.163-1.633-.943-3.706-.388-7.853.724-4.147 1.11-6.22 1.666-7.163 3.3-.943 1.633-.388 3.706.724 7.853 1.11 4.147 1.666 6.22 3.3 7.163Z"
        opacity={0.5}
      />
      <path
        fill="currentColor"
