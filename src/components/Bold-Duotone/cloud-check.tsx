  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M12 22c-1.886 0-2.828 0-3.414-.586C8 20.828 8 19.886 8 18c0-1.886 0-2.828.586-3.414C9.172 14 10.114 14 12 14c1.886 0 2.828 0 3.414.586C16 15.172 16 16.114 16 18c0 1.886 0 2.828-.586 3.414C14.828 22 13.886 22 12 22Zm2.25-4.862a.667.667 0 0 0-.944-.943l-2.195 2.195-.417-.417a.667.667 0 0 0-.943.943l.889.889c.26.26.682.26.942 0l2.667-2.667Z"
        clipRule="evenodd"
      />
    </svg>
  );
