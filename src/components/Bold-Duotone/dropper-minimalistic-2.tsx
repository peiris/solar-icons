...
const SvgDropperMinimalistic2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M18.998 7.25H17a.75.75 0 0 0 0 1.5h2V8c0-.269 0-.518-.002-.75ZM19 10.25h-2a.75.75 0 0 0 0 1.5h2v-1.5ZM19 13.25h-2a.75.75 0 0 0 0 1.5h2v-1.5ZM14 4a2 2 0 1 0-4 0h4ZM11.25 20.235c.5.042 1 .042 1.5 0v1.015a.75.75 0 0 1-1.5 0v-1.015Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M9.25 16a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75Z"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
