...
const SvgInboxUnread = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M3.465 20.536C4.929 22 7.286 22 12 22c4.715 0 7.072 0 8.536-1.465C21.893 19.179 21.993 17.056 22 13h-3.16c-.905 0-1.358 0-1.755.183-.398.183-.693.527-1.282 1.214l-.605.706c-.59.687-.884 1.031-1.282 1.214-.398.183-.85.183-1.755.183h-.321c-.905 0-1.358 0-1.756-.183-.397-.183-.692-.527-1.281-1.214l-.606-.706c-.589-.687-.883-1.031-1.281-1.214C6.518 13 6.066 13 5.16 13H2c.007 4.055.107 6.179 1.465 7.535Z"
      />
    </svg>
  );
};
