  ...
  return (
    ...
    >
      <g
        ...
        opacity={0.3}
      >
        <path d="M18.5 14c-1.933 0-3.5 1.458-3.5 3.257 0 1.785 1.117 3.868 2.86 4.613.406.173.874.173 1.28 0 1.743-.745 2.86-2.828 2.86-4.613C22 15.458 20.433 14 18.5 14ZM5.5 2C3.567 2 2 3.458 2 5.257 2 7.042 3.117 9.125 4.86 9.87c.406.173.874.173 1.28 0C7.883 9.125 9 7.042 9 5.257 9 3.458 7.433 2 5.5 2Z" />
      </g>
      <path
        fill="currentColor"
