...
const SvgMouse = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.75 8.974V6.97c0-.7-.409-1.303-1-1.585V2a7.065 7.065 0 0 0-1.5 0v3.385c-.591.282-1 .885-1 1.585v2.004c0 .968.784 1.753 1.75 1.753s1.75-.785 1.75-1.753Z"
      />
    </svg>
  );
};
