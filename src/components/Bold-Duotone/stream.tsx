...
const SvgStream = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m17 9.5.658-.329c1.946-.973 2.92-1.46 3.63-1.02.712.44.712 1.528.712 3.703v.292c0 2.176 0 3.263-.711 3.703-.712.44-1.685-.047-3.63-1.02L17 14.5v-5ZM9.5 7.75a.75.75 0 0 1 .576.27l2.5 3a.75.75 0 1 1-1.152.96l-1.174-1.408V15.5a.75.75 0 1 1-1.5 0v-4.928L7.576 11.98a.75.75 0 0 1-1.152-.96l2.5-3a.75.75 0 0 1 .576-.27Z"
      />
    </svg>
  );
};
