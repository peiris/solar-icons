  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M8.25 15.5a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Zm1.5 0a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="M16 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM12 10a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM10 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM9 4.75a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5H9Z"
      />
    </svg>
  );
};
