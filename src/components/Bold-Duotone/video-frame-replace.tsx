...
const SvgVideoFrameReplace = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M19.043 6.767A17.091 17.091 0 0 0 18 6.75a.75.75 0 0 1 0-1.5h.025c.445 0 .816 0 1.12.02.317.022.617.07.907.19a2.75 2.75 0 0 1 1.489 1.488c.084.204.12.464.14.664.025.229.04.495.05.767.01.296.015.613.017.914a.75.75 0 0 1 .782 1.237l-1 1a.75.75 0 0 1-1.06 0l-1-1a.75.75 0 0 1 .778-1.238 30.628 30.628 0 0 0-.017-.86 10.19 10.19 0 0 0-.041-.663c-.015-.142-.03-.215-.035-.24-.002-.012-.003-.014 0-.007a1.25 1.25 0 0 0-.677-.677c-.077-.032-.194-.061-.435-.078Z"
        opacity={0.3}
      />
      <g fill="currentColor" opacity={0.3}>
        <path d="M12.75 14.01c-1.086.027-1.725.137-2.164.576-.502.502-.574 1.267-.584 2.664h2.748v-3.24ZM10.002 18.75c.01 1.397.082 2.162.584 2.664.439.44 1.078.55 2.164.577V18.75h-2.748ZM14.25 22h2.5v-8h-2.5v8ZM18.25 14.01v3.24H21c-.01-1.397-.082-2.162-.584-2.664-.44-.44-1.079-.55-2.165-.577ZM20.999 18.75H18.25v3.24c1.086-.027 1.726-.137 2.165-.576.502-.502.573-1.267.584-2.664Z" />
      </g>
    </svg>
  );
};
