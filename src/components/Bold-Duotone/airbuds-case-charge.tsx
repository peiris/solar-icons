...
const SvgAirbudsCaseCharge = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7 8.25a.75.75 0 0 0 0 1.5h10a.75.75 0 0 0 0-1.5H7ZM12.586 13.469a.75.75 0 0 0-1.172-.937l-2 2.5A.75.75 0 0 0 10 16.25h2.44l-1.026 1.282a.75.75 0 1 0 1.172.936l2-2.5A.75.75 0 0 0 14 14.75h-2.44l1.026-1.281Z"
      />
    </svg>
  );
};
