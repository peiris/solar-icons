...
const SvgMoneyBag = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3.172 7.172c.843-.844 2.058-1.08 4.08-1.146l1.5-.024C9.143 6 9.56 6 10 6h4c.441 0 .857 0 1.248.002l1.5.024c2.022.066 3.237.302 4.08 1.146C22 8.343 22 10.229 22 14c0 3.771 0 5.657-1.172 6.828C19.657 22 17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14c0-3.771 0-5.657 1.172-6.828Z"
        opacity={0.5}
      />
      <path
        fill="currentColor"
