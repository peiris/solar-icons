  ...
  return (
    ...
    >
      ...
      <g fill="currentColor" opacity={0.3}>
        <path d="M8 6.25v-1.5h8v1.5h-3.25V8a.75.75 0 0 1-1.5 0V6.25H8ZM8 19.25h8v-1.5h-3.25V16a.75.75 0 0 0-1.5 0v1.75H8v1.5Z" />
      </g>
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M9.47 9.47a.75.75 0 0 1 1.06 0L12 10.94l1.47-1.47a.75.75 0 1 1 1.06 1.06L13.06 12l1.47 1.47a.75.75 0 1 1-1.06 1.06L12 13.06l-1.47 1.47a.75.75 0 1 1-1.06-1.06L10.94 12l-1.47-1.47a.75.75 0 0 1 0-1.06Z"
        clipRule="evenodd"
      />
    </svg>
  );
