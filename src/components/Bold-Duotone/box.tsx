...
const SvgBox = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m6.323 4.484.1-.052 1.493-.784 9.1 5.005 4.025-2.011c.137.155.257.32.362.498.15.254.262.524.346.825L17.75 9.964V13a.75.75 0 0 1-1.5 0v-2.286l-3.5 1.75v9.44A3.062 3.062 0 0 1 12 22c-.248 0-.493-.032-.75-.096v-9.44l-8.998-4.5c.084-.3.196-.57.346-.824.105-.178.224-.343.362-.498l9.04 4.52 3.387-1.693-9.064-4.985Z"
      />
    </svg>
  );
};
