...
const SvgCart3 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M10 2a1.75 1.75 0 1 0 0 3.5h4A1.75 1.75 0 1 0 14 2h-4ZM3.863 16.205c-.858-3.432-1.287-5.147-.386-6.301.901-1.154 2.67-1.154 6.207-1.154h4.63c3.538 0 5.307 0 6.208 1.154.9 1.153.472 2.87-.386 6.301-.546 2.183-.819 3.274-1.633 3.91-.813.635-1.938.635-4.188.635h-4.63c-2.25 0-3.376 0-4.19-.635-.813-.636-1.086-1.727-1.632-3.91Z"
        opacity={0.5}
      />
      <path
        fill="currentColor"
