  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M10.833 10.624a2 2 0 1 1 2.335 0l3.547 11.149a.75.75 0 0 1-1.287.712L12 18.434l-3.427 4.05a.75.75 0 0 1-1.288-.711l3.548-11.149Zm2.15 6.649 1.164 1.375-.637-2-.527.625Zm-.008-2.308a.78.78 0 0 0-.047.05L12 16.113l-.927-1.096a.78.78 0 0 0-.047-.051L12 11.902l.975 3.063Zm-2.485 1.684.528.624-1.164 1.375.636-2Z"
        clipRule="evenodd"
      />
