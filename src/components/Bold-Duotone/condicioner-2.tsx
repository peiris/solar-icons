...
const SvgCondicioner2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M5.25 18.797c0-.832.004-1.53.08-2.091.084-.628.27-1.195.725-1.65.456-.456 1.023-.642 1.65-.726.595-.08 1.344-.08 2.243-.08h4.104c.899 0 1.648 0 2.242.08.628.084 1.195.27 1.65.726.456.455.642 1.022.726 1.65.075.56.08 1.26.08 2.091H5.25Z"
        opacity={0.3}
      />
    </svg>
  );
