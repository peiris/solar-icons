...
const SvgMusicLibrary = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M6.31 4.723c-1.39 0-2.53.84-2.91 1.953a2.623 2.623 0 0 0-.024.07c.399-.12.813-.199 1.232-.253 1.08-.138 2.446-.138 4.032-.138h6.892c1.586 0 2.952 0 4.032.138.42.054.834.133 1.232.253a2.817 2.817 0 0 0-.023-.07c-.38-1.114-1.52-1.953-2.911-1.953H6.31Z"
        opacity={0.7}
      />
    </svg>
  );
