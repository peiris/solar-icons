...
const SvgAlbum = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17.29 11.968a1.33 1.33 0 0 1-1.322 1.338 1.33 1.33 0 0 1-1.323-1.338 1.33 1.33 0 0 1 1.323-1.337c.73 0 1.323.599 1.323 1.337Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
      ...
      <path
        fill="currentColor"
        d="M6.88 4.5c-1.252 0-2.279.84-2.621 1.954a2.772 2.772 0 0 0-.02.07c.358-.12.73-.2 1.108-.253.972-.139 2.201-.139 3.629-.139h6.202c1.428 0 2.657 0 3.63.139.377.053.75.132 1.108.253a2.773 2.773 0 0 0-.02-.07c-.343-1.114-1.37-1.954-2.62-1.954H6.878Z"
        opacity={0.7}
      />
      <path
        fill="currentColor"
        d="M8.859 2h6.282c.209 0 .37 0 .51.015a2.623 2.623 0 0 1 2.159 1.672H6.19a2.623 2.623 0 0 1 2.159-1.672c.14-.015.3-.015.51-.015Z"
        opacity={0.4}
      />
    </svg>
  );
