...
const SvgLockKeyholeMinimalisticUnlocked = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12.75 14a.75.75 0 0 0-1.5 0v4a.75.75 0 0 0 1.5 0v-4ZM6.75 8a5.25 5.25 0 0 1 10.335-1.313.75.75 0 0 0 1.452-.374A6.75 6.75 0 0 0 5.25 8v2.055a23.57 23.57 0 0 1 1.5-.051V8Z"
      />
    </svg>
  );
};
