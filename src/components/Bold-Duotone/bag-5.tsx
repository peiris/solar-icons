...
const SvgBag5 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M4.035 16.927c.462 2.309.693 3.463 1.522 4.143.83.68 2.007.68 4.362.68h4.162c2.355 0 3.532 0 4.361-.68.83-.68 1.06-1.834 1.523-4.143l.6-3c.664-3.32.996-4.98.096-6.079-.9-1.098-2.594-1.098-5.98-1.098H9.32c-3.386 0-5.08 0-5.98 1.098-.9 1.098-.568 2.758.096 6.079l.6 3Z"
        opacity={0.5}
      />
