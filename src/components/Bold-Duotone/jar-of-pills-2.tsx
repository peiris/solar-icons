...
const SvgJarOfPills2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M9 5 5.501 7.799A4 4 0 0 0 4.108 10h15.788a4 4 0 0 0-1.379-2.2L16.16 5.89 15.018 5H9ZM4.927 20.113A4 4 0 0 1 4.025 18h7.78c-.56 1.31-.336 2.86.58 4H8.957c-.571 0-.857 0-1.127-.037a4 4 0 0 1-2.152-1.008c-.202-.184-.385-.404-.75-.842Z"
      />
      <path
        fill="currentColor"
      ...
      <path
        fill="currentColor"
        d="M18.82 19.634a4.792 4.792 0 0 0-.168-.377 6.46 6.46 0 0 0-1.231-1.678 6.464 6.464 0 0 0-1.678-1.232 4.77 4.77 0 0 0-.377-.168l-1.226 1.226.47.1.01.003a2.99 2.99 0 0 1 .454.183c.324.16.786.448 1.286.949.5.5.789.962.95 1.285a2.995 2.995 0 0 1 .182.454l.003.011.1.47 1.226-1.226Z"
      />
    </svg>
  );
};
