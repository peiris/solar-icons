...
const SvgBag2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M9.75 5a2.25 2.25 0 0 1 4.5 0v1c.566 0 1.062.002 1.5.015V5a3.75 3.75 0 1 0-7.5 0v1.015C8.688 6.002 9.184 6 9.75 6V5ZM8.26 10.877a.75.75 0 1 1 1.48.246l-1 6a.75.75 0 1 1-1.48-.246l1-6ZM14.877 10.26a.75.75 0 0 1 .863.617l1 6a.75.75 0 1 1-1.48.246l-1-6a.75.75 0 0 1 .617-.863Z"
      />
    </svg>
  );
};
