...
const SvgAirbuds = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13 17.25h4.765v1.5H13v-1.5ZM11 17.25H6.235v1.5H11v-1.5ZM19.5 5.25a.75.75 0 0 1 .75.75v2.5a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75ZM4.5 5.25a.75.75 0 0 0-.75.75v2.5a.75.75 0 0 0 1.5 0V6a.75.75 0 0 0-.75-.75Z"
      />
    </svg>
  );
};
