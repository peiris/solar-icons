...
const SvgLaptop3 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M14.5 2h-5c-2.828 0-4.243 0-5.121.879C3.5 3.757 3.5 5.172 3.5 8v3.5c0 1.886 0 2.828.586 3.414.586.586 1.528.586 3.414.586h9c1.886 0 2.828 0 3.414-.586.586-.586.586-1.528.586-3.414V8c0-2.828 0-4.243-.879-5.121C18.743 2 17.328 2 14.5 2Z"
        opacity={0.3}
      />
      <path
        fill="currentColor"
