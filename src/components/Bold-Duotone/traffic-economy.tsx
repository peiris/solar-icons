...
const SvgTrafficEconomy = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.31 6.045a.75.75 0 0 1 .986-.393 7.734 7.734 0 0 1 4.052 4.052.75.75 0 0 1-1.378.591 6.234 6.234 0 0 0-3.265-3.265.75.75 0 0 1-.394-.985ZM12 9.75a.75.75 0 0 1 .75.75v.75h.75a.75.75 0 1 1 0 1.5h-.75v.75a.75.75 0 1 1-1.5 0v-.75h-.75a.75.75 0 0 1 0-1.5h.75v-.75a.75.75 0 0 1 .75-.75Z"
      />
    </svg>
  );
};
