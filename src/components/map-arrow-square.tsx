...
const SvgMapArrowSquare = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="m13.423 17.362 3.512-9.166a.863.863 0 0 0-1.131-1.13l-9.166 3.511c-.83.319-.857 1.483-.04 1.731l3.477 1.057c.27.082.478.29.56.56l1.057 3.477c.248.817 1.412.79 1.73-.04Z" />
    </svg>
  );
};
