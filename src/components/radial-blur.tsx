...
const SvgRadialBlur = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M15.5 14.25a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM15.5 9.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM11 14.25a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM11 9.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM15 18.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM10.5 18.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
