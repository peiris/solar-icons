...
const SvgHeadphonesSquare = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path d="M21 18v-6c0-3.75 0-5.625-.955-6.939a5 5 0 0 0-1.106-1.106C17.625 3 15.749 3 12 3c-3.75 0-5.625 0-6.939.955A5 5 0 0 0 3.955 5.06C3 6.375 3 8.251 3 12v6M22 15.5v2M2 15.5v2" />
