...
const SvgGalleryWide = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="m4 7-.012-1c.112-.931.347-1.574.837-2.063C5.765 3 7.279 3 10.307 3h3.211c3.028 0 4.541 0 5.482.937.49.489.725 1.132.837 2.063v1" />
      <circle cx={17.5} cy={10.5} r={1.5} />
      <path d="m2 14.5 1.752-1.533a2.3 2.3 0 0 1 3.14.105l4.29 4.29a2 2 0 0 0 2.564.222l.299-.21a3 3 0 0 1 3.731.225L21 20.5" />
    </svg>
  );
};
