...
const SvgMedalStarSquare = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M14 6h-4c-2.828 0-4.243 0-5.121.879C4 7.757 4 9.172 4 12v1.056c0 2.405 0 3.608.597 4.575.598.966 1.674 1.504 3.825 2.58 1.756.878 2.634 1.317 3.578 1.317s1.822-.439 3.578-1.317c2.151-1.076 3.227-1.614 3.825-2.58.597-.967.597-2.17.597-4.575V12c0-2.828 0-4.243-.879-5.121C18.243 6 16.828 6 14 6Z" />
    </svg>
  );
};
