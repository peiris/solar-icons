  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M15 19H9M16.748 2.378l-.084.126c-.756 1.134-1.134 1.701-1.686 2.044a3 3 0 0 1-.342.183c-.592.27-1.273.27-2.636.27-1.363 0-2.045 0-2.636-.27a3.002 3.002 0 0 1-.342-.183c-.552-.343-.93-.91-1.686-2.044l-.084-.126"
        opacity={0.5}
      />
    </svg>
  );
