...
const SvgSignpost = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12.75 2a.75.75 0 0 0-1.5 0h1.5Zm0 9a.75.75 0 0 0-1.5 0h1.5Zm0 9a.75.75 0 0 0-1.5 0h1.5ZM14 22.75a.75.75 0 0 0 0-1.5v1.5Zm-4-1.5a.75.75 0 0 0 0 1.5v-1.5ZM11.25 2v1h1.5V2h-1.5Zm0 9v1h1.5v-1h-1.5Zm0 9v2h1.5v-2h-1.5ZM14 21.25h-4v1.5h4v-1.5Z"
        opacity={0.5}
      />
    </svg>
  );
