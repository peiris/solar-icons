  ...
  return (
    ...
    >
      <path
        ...
        d="M2.5 6.5a4 4 0 1 1 8 0v2.667c0 .31 0 .465-.034.592a1 1 0 0 1-.707.707c-.127.034-.282.034-.592.034H6.5a4 4 0 0 1-4-4ZM13.5 14.833c0-.31 0-.465.034-.592a1 1 0 0 1 .707-.707c.127-.034.282-.034.592-.034H17.5a4 4 0 1 1-4 4v-2.667Z"
        opacity={0.5}
      />
      <path
        stroke="currentColor"
