  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity={0.5}
      />
      <circle cx={8} cy={13} r={1} fill="#1C274D" opacity={0.5} />
      <circle cx={8} cy={17} r={1} fill="#1C274D" opacity={0.5} />
      <circle cx={12} cy={13} r={1} fill="#1C274D" opacity={0.5} />
      <circle cx={12} cy={17} r={1} fill="#1C274D" opacity={0.5} />
      <circle cx={16} cy={13} r={1} fill="#1C274D" opacity={0.5} />
      <circle cx={16} cy={17} r={1} fill="#1C274D" opacity={0.5} />
    </svg>
  );
};
