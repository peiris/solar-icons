  ...
  return (
    ...
    >
      ...
      <path
        ...
        d="M14.996 8.252a6.47 6.47 0 0 0-.868-3.001 6.489 6.489 0 0 0-4.85-3.204 6.499 6.499 0 1 0-1.12 12.943M9.215 2s-.138 2.356 1.357 5.19c.457.869.956 1.569 1.428 2.123M3 5.928s1.933 1.047 3.428 3.881C7.923 12.644 7.785 15 7.785 15"
        opacity={0.5}
      />
      <path
        stroke="currentColor"
