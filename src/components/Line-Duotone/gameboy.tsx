  ...
  return (
    ...
    >
      ...
      <g fill="currentColor" opacity={0.5}>
        <path d="M16.333 13.833a.833.833 0 1 1-1.666 0 .833.833 0 0 1 1.666 0ZM16.333 17.167a.833.833 0 1 1-1.666 0 .833.833 0 0 1 1.666 0ZM14.667 15.5a.833.833 0 1 1-1.667 0 .833.833 0 0 1 1.667 0ZM18 15.5a.833.833 0 1 1-1.667 0 .833.833 0 0 1 1.667 0Z" />
      </g>
    </svg>
  );
};
