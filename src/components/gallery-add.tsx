...
const SvgGalleryAdd = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="m2 12.5 1.752-1.533a2.3 2.3 0 0 1 3.14.105l4.29 4.29a2 2 0 0 0 2.564.222l.299-.21a3 3 0 0 1 3.731.225L21 18.5M15 5.5h3.5m0 0H22m-3.5 0V9m0-3.5V2" />
    </svg>
  );
};
