...
const SvgMusicLibrary2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M12 17a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 0v-6.5c0 1.657 1.895 3 3 3M19.562 7a2.132 2.132 0 0 0-2.1-2.5H6.538a2.132 2.132 0 0 0-2.1 2.5M17.5 4.5c.028-.26.043-.389.043-.496a2 2 0 0 0-1.787-1.993C15.65 2 15.52 2 15.26 2H8.74c-.26 0-.391 0-.497.011a2 2 0 0 0-1.787 1.993c0 .107.014.237.043.496" />
    </svg>
  );
};
