...
const SvgTextSquare2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7.25 8A.75.75 0 0 1 8 7.25h8a.75.75 0 0 1 0 1.5h-3.25V16a.75.75 0 0 1-1.5 0V8.75H8A.75.75 0 0 1 7.25 8ZM19.25 12a.75.75 0 0 1 .75-.75h2a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1-.75-.75ZM2 11.25a.75.75 0 0 0 0 1.5h2a.75.75 0 0 0 0-1.5H2Z"
      />
    </svg>
  );
};
