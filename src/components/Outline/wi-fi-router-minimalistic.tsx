...
const SvgWiFiRouterMinimalistic = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M16.5 4.75a4.752 4.752 0 0 0-4.391 2.934.75.75 0 1 1-1.386-.574 6.252 6.252 0 0 1 11.553 0 .75.75 0 0 1-1.386.574A4.752 4.752 0 0 0 16.5 4.75Z"
      />
      <path
        fill="currentColor"
        d="M16.5 7.25a2.251 2.251 0 0 0-2.16 1.618.75.75 0 1 1-1.44-.42 3.751 3.751 0 0 1 7.2 0 .75.75 0 1 1-1.44.42A2.251 2.251 0 0 0 16.5 7.25ZM6 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM9 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
