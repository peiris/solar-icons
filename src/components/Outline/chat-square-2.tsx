...
const SvgChatSquare2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M7.75 15a.75.75 0 0 0-1.5 0v3a.75.75 0 0 0 1.5 0v-3ZM12 11.25a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-1.5 0v-6a.75.75 0 0 1 .75-.75ZM17.75 9a.75.75 0 0 0-1.5 0v9a.75.75 0 0 0 1.5 0V9Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
