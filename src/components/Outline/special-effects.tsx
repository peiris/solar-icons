...
const SvgSpecialEffects = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12.6 7.55a.75.75 0 1 0-1.2.9L14.062 12 11.4 15.55a.75.75 0 1 0 1.2.9l2.4-3.2 2.4 3.2a.75.75 0 1 0 1.2-.9L15.937 12 18.6 8.45a.75.75 0 1 0-1.2-.9l-2.4 3.2-2.4-3.2ZM6 7.25a.75.75 0 0 0-.75.75v8a.75.75 0 0 0 1.5 0v-3.25H10a.75.75 0 0 0 0-1.5H6.75v-2.5H10a.75.75 0 0 0 0-1.5H6Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
