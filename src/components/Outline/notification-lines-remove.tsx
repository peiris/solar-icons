...
const SvgNotificationLinesRemove = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17.53 1.47a.75.75 0 1 0-1.06 1.06l1.97 1.97-1.97 1.97a.75.75 0 1 0 1.06 1.06l1.97-1.97 1.97 1.97a.75.75 0 0 0 1.06-1.06L20.56 4.5l1.97-1.97a.75.75 0 0 0-1.06-1.06L19.5 3.44l-1.97-1.97Z"
      />
      <path
        fill="currentColor"
      ...
      <path
        fill="currentColor"
        d="M7 13.25a.75.75 0 0 0 0 1.5h9a.75.75 0 0 0 0-1.5H7ZM6.25 17.5a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75Z"
      />
    </svg>
  );
};
