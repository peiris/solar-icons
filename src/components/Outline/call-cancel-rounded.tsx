...
const SvgCallCancelRounded = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M16.53 3.47a.75.75 0 0 0-1.06 1.06L16.94 6l-1.47 1.47a.75.75 0 0 0 1.06 1.06L18 7.06l1.47 1.47a.75.75 0 0 0 1.06-1.06L19.06 6l1.47-1.47a.75.75 0 1 0-1.06-1.06L18 4.94l-1.47-1.47Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
