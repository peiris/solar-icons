...
const SvgGraphDownNew = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M6.47 9.47a.75.75 0 0 1 1.06 0l2.293 2.293a.25.25 0 0 0 .354 0l1.586-1.586a1.75 1.75 0 0 1 2.474 0l2.013 2.012V11.5a.75.75 0 0 1 1.5 0V14a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h.69l-2.013-2.013a.25.25 0 0 0-.354 0l-1.586 1.586a1.75 1.75 0 0 1-2.474 0L6.47 10.53a.75.75 0 0 1 0-1.06Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M19 1.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5ZM16.75 5a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z"
        clipRule="evenodd"
      />
    </svg>
  );
