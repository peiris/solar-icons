...
const SvgChartSquare = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M7.75 9a.75.75 0 0 0-1.5 0v9a.75.75 0 0 0 1.5 0V9ZM12 5.25a.75.75 0 0 1 .75.75v12a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75ZM17.75 13a.75.75 0 0 0-1.5 0v5a.75.75 0 0 0 1.5 0v-5Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
