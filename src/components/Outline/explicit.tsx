...
const SvgExplicit = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M10 6.25A1.75 1.75 0 0 0 8.25 8v8c0 .966.784 1.75 1.75 1.75h5a.75.75 0 0 0 0-1.5h-5a.25.25 0 0 1-.25-.25v-3.25H15a.75.75 0 0 0 0-1.5H9.75V8a.25.25 0 0 1 .25-.25h5a.75.75 0 0 0 0-1.5h-5Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
