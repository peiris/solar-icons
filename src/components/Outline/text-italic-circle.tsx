...
const SvgTextItalicCircle = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M10.667 6.25h2.65a.74.74 0 0 1 .033 0H16a.75.75 0 0 1 0 1.5h-2.09l-2.267 8.5h1.69a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5h2.09l2.267-8.5h-1.69a.75.75 0 0 1 0-1.5Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
