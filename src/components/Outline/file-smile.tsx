...
const SvgFileSmile = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M18 14.5c0 .829-.448 1.5-1 1.5s-1-.671-1-1.5c0-.828.448-1.5 1-1.5s1 .672 1 1.5Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M8.376 17.084a.75.75 0 0 1 1.04-.208 4.658 4.658 0 0 0 5.168 0 .75.75 0 1 1 .832 1.248 6.158 6.158 0 0 1-6.832 0 .75.75 0 0 1-.208-1.04Z"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="M8 14.5c0 .829-.448 1.5-1 1.5s-1-.671-1-1.5c0-.828.448-1.5 1-1.5s1 .672 1 1.5Z"
      />
    </svg>
  );
};
