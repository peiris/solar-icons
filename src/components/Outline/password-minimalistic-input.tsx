  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M15.75 2a.75.75 0 0 0-1.5 0v20a.75.75 0 0 0 1.5 0v-1.256c1.21-.012 2.22-.053 3.059-.196 1.028-.174 1.872-.511 2.55-1.19.748-.748 1.08-1.697 1.238-2.869.153-1.14.153-2.595.153-4.433v-.112c0-1.838 0-3.294-.153-4.433-.158-1.172-.49-2.121-1.238-2.87-.678-.678-1.522-1.015-2.55-1.19-.839-.142-1.85-.183-3.059-.195V2Zm0 2.756v14.488c1.186-.012 2.09-.052 2.808-.174.842-.143 1.355-.387 1.74-.772.423-.423.677-1.003.812-2.009.138-1.028.14-2.382.14-4.289 0-1.907-.002-3.261-.14-4.29-.135-1.005-.389-1.585-.812-2.008-.385-.385-.898-.629-1.74-.772-.719-.122-1.622-.162-2.808-.174Z"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
      ...
      <path
        fill="currentColor"
        d="M8 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM13 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
      />
    </svg>
  );
};
