...
const SvgCaseRoundMinimalistic = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M21.662 8.72c-3.01 1.956-4.515 2.934-6.101 3.427a12 12 0 0 1-7.121 0c-1.587-.493-3.092-1.47-6.102-3.427M8 11v2M16 11v2M9.17 4a3.001 3.001 0 0 1 5.66 0" />
    </svg>
  );
};
