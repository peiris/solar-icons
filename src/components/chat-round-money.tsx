...
const SvgChatRoundMoney = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path d="M12 15.333c1.105 0 2-.746 2-1.666 0-.92-.895-1.667-2-1.667s-2-.746-2-1.667c0-.92.895-1.666 2-1.666m0 6.666c-1.105 0-2-.746-2-1.666m2 1.666V16m0-8v.667m0 0c1.105 0 2 .746 2 1.666" />
    </svg>
  );
};
