...
const SvgGamepadCharge = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12.75 18.968A1 1 0 0 0 13.5 18v-.727a.38.38 0 0 0-.26-.36 3.923 3.923 0 0 0-2.48 0 .38.38 0 0 0-.26.36V18a1 1 0 0 0 .75.968v3.282a.75.75 0 1 0 1.5 0v-3.282Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
