...
const SvgPlayStream = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.656 10.451c.896.658 1.344.987 1.344 1.55 0 .562-.448.89-1.344 1.548a12.83 12.83 0 0 1-.718.495c-.197.125-.421.254-.653.381-.894.49-1.34.734-1.741.463-.401-.27-.437-.838-.51-1.971-.02-.32-.034-.635-.034-.917 0-.282.013-.596.034-.917.072-1.133.109-1.7.51-1.97.4-.271.847-.027 1.74.462.233.127.457.256.654.381.226.143.471.314.718.495Z"
      />
    </svg>
  );
};
