...
const SvgSliderVerticalMinimalistic = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M5.846 8c0-2.828 0-4.243.901-5.121C7.65 2 9.1 2 12 2c2.901 0 4.351 0 5.253.879.9.878.9 2.293.9 5.121v8c0 2.828 0 4.243-.9 5.121C16.35 22 14.9 22 12 22c-2.901 0-4.351 0-5.253-.879-.9-.878-.9-2.293-.9-5.121V8Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
