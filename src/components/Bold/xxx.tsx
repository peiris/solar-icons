...
const SvgXxx = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M9.124 9.416 7.401 12l1.723 2.584a.746.746 0 0 1 .126.405.746.746 0 0 1 .126-.405L11.099 12 9.376 9.416a.746.746 0 0 1-.126-.404.746.746 0 0 1-.126.404ZM14.624 9.416 12.901 12l1.723 2.584a.746.746 0 0 1 .126.405.746.746 0 0 1 .126-.405L16.599 12l-1.723-2.584a.746.746 0 0 1-.126-.405.746.746 0 0 1-.126.405Z"
      />
    </svg>
  );
};
