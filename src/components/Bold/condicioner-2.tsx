...
const SvgCondicioner2 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M17.25 18.953c0-.938-.003-1.572-.067-2.048-.062-.461-.169-.659-.3-.789-.13-.13-.327-.237-.788-.3-.483-.064-1.131-.066-2.095-.066h-4c-.964 0-1.612.002-2.095.066-.461.063-.659.17-.789.3-.13.13-.237.328-.3.79-.063.475-.066 1.109-.066 2.047C7.645 19 8.712 19 10 19h4c1.288 0 2.355 0 3.25-.047Z"
      />
    </svg>
  );
};
