  ...
  return (
    ...
    >
      <path
        fill="#1C274D"
        fillRule="evenodd"
        d="M2 12V8c0-2.828 0-4.243.879-5.121C3.757 2 5.172 2 8 2h8c2.828 0 4.243 0 5.121.879C22 3.757 22 5.172 22 8v4c0 2.828 0 4.243-.879 5.121-.646.647-1.582.818-3.158.863a3.204 3.204 0 0 0-.767-2.066.211.211 0 0 1-.05-.12 3.21 3.21 0 0 0-2.944-2.945.21.21 0 0 1-.12-.05 3.21 3.21 0 0 0-4.164 0 .21.21 0 0 1-.12.05 3.21 3.21 0 0 0-2.945 2.945.21.21 0 0 1-.05.12 3.204 3.204 0 0 0-.766 2.066c-1.576-.045-2.512-.216-3.158-.863C2 16.243 2 14.828 2 12Zm6.25-6A.75.75 0 0 1 9 5.25h6a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 8.25 6ZM7 8.75a.75.75 0 0 0 0 1.5h10a.75.75 0 0 0 0-1.5H7Z"
        clipRule="evenodd"
      />
      <path
        fill="#1C274D"
        fillRule="evenodd"
        d="M13.11 13.945a1.71 1.71 0 0 0-2.22 0 1.71 1.71 0 0 1-.973.403 1.71 1.71 0 0 0-1.569 1.57c-.028.358-.17.698-.403.973a1.71 1.71 0 0 0 0 2.218c.234.274.375.615.403.973a1.71 1.71 0 0 0 1.57 1.57c.358.028.699.169.973.402a1.71 1.71 0 0 0 2.218 0 1.71 1.71 0 0 1 .973-.403 1.71 1.71 0 0 0 1.57-1.569c.028-.358.169-.699.402-.973a1.71 1.71 0 0 0 0-2.219 1.71 1.71 0 0 1-.403-.973 1.71 1.71 0 0 0-1.569-1.569 1.71 1.71 0 0 1-.973-.403Zm.902 3.603a.75.75 0 1 0-1.024-1.096l-1.63 1.522-.346-.322a.75.75 0 0 0-1.024 1.096l.857.8a.75.75 0 0 0 1.024 0l2.143-2Z"
        clipRule="evenodd"
      />
    </svg>
  );
