...
const SvgMedalStarCircle = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M11 2h2c1.886 0 2.828 0 3.414.586.578.577.586 1.502.586 3.335A9.456 9.456 0 0 0 12 4.5c-1.835 0-3.548.52-5 1.42 0-1.832.008-2.757.586-3.334C8.172 2 9.114 2 11 2Z"
      />
    </svg>
  );
};
