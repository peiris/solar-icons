...
const SvgStreetsMapPoint = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M21.89 7.172C22 8.433 22 10.006 22 12c0 4.134 0 6.455-.987 7.951L15.06 14l6.828-6.828ZM19.952 21.012 14 15.06l-6.828 6.83C8.433 22 10.006 22 12 22c4.134 0 6.456 0 7.952-.988Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
