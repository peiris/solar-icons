...
const SvgMirror1 = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M3 12a9 9 0 1 1 17.294 3.5h-3.466a3.5 3.5 0 0 0-2.474 1.025l-.829.829a.5.5 0 0 1-.353.146h-2.344a.5.5 0 0 1-.353-.146l-.829-.829A3.5 3.5 0 0 0 7.172 15.5H3.706A8.972 8.972 0 0 1 3 12Z"
      />
    </svg>
  );
};
