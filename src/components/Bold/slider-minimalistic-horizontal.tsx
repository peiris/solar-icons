...
const SvgSliderMinimalisticHorizontal = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M16 5.846c2.828 0 4.243 0 5.121.901C22 7.65 22 9.1 22 12c0 2.901 0 4.351-.879 5.253-.878.9-2.293.9-5.121.9H8c-2.828 0-4.243 0-5.121-.9C2 16.35 2 14.9 2 12c0-2.901 0-4.351.879-5.253.878-.9 2.293-.9 5.121-.9h8Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
