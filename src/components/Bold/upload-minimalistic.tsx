...
const SvgUploadMinimalistic = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12.554 2.494a.75.75 0 0 0-1.107 0l-4 4.375A.75.75 0 0 0 8.553 7.88l2.696-2.95V16a.75.75 0 0 0 1.5 0V4.932l2.697 2.95a.75.75 0 1 0 1.107-1.013l-4-4.375Z"
      />
      <path
        fill="currentColor"
