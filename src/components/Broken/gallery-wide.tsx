  ...
  return (
    ...
    >
      <path
        ...
        d="M22 13.438c0 3.77 0 5.656-1.172 6.828-1.171 1.172-3.057 1.172-6.828 1.172h-4c-3.771 0-5.657 0-6.828-1.172C2 19.094 2 17.209 2 13.438 2 9.666 2 7.78 3.172 6.609 4.343 5.438 6.229 5.438 10 5.438h4c3.771 0 5.657 0 6.828 1.171.664.664.952 1.556 1.076 2.891"
      />
      <path
        stroke="currentColor"
