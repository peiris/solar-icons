  ...
  return (
    ...
    >
      <path
        ...
        d="M21.483 19c-.04.936-.165 1.51-.569 1.914-.586.586-1.528.586-3.414.586-1.886 0-2.828 0-3.414-.586-.586-.586-.586-1.528-.586-3.414v-2c0-1.886 0-2.828.586-3.414.586-.586 1.528-.586 3.414-.586 1.886 0 2.828 0 3.414.586.532.531.581 1.357.585 2.914"
      />
      <path
        stroke="currentColor"
        
        d="M2 8.5c0 1.886 0 2.828.586 3.414.586.586 1.528.586 3.414.586 1.886 0 2.828 0 3.414-.586C10 11.328 10 10.386 10 8.5v-2c0-1.886 0-2.828-.586-3.414C8.828 2.5 7.886 2.5 6 2.5c-1.886 0-2.828 0-3.414.586C2 3.672 2 4.614 2 6.5v2Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
