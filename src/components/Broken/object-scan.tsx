  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M22 14v1m-8 7c3.771 0 5.657 0 6.828-1.172.654-.653.943-1.528 1.07-2.828M10 22c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14M2 10V9m8-7C6.229 2 4.343 2 3.172 3.172 2.518 3.825 2.229 4.7 2.102 6M14 2c3.771 0 5.657 0 6.828 1.172C22 4.343 22 6.229 22 10M4 11.5s2.4-2 8-2 8 2 8 2"
      />
      <path
        fill="currentColor"
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M14 18.5c1.886 0 2.828 0 3.414-.586C18 17.328 18 16.386 18 14.5V14m-8 4.5c-1.886 0-2.828 0-3.414-.586C6 17.328 6 16.386 6 14.5V14"
      />
    </svg>
  );
};
