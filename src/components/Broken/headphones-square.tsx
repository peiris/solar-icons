  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M21 18v-6c0-3.75 0-5.625-.955-6.939a5 5 0 0 0-1.106-1.106C17.625 3 15.749 3 12 3c-.735 0-1.399 0-2 .007M3 18v-6c0-3.75 0-5.625.955-6.939A5 5 0 0 1 5.06 3.955c.283-.205.591-.367.939-.493M22 15.5v2M2 15.5v2"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
