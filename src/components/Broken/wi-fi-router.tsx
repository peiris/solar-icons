  ...
  return (
    ...
    >
      ...
      <path
        ...
        d="M13 19H6c-1.886 0-2.828 0-3.414-.586C2 17.828 2 16.886 2 15c0-1.886 0-2.828.586-3.414C3.172 11 4.114 11 6 11h12c1.886 0 2.828 0 3.414.586C22 12.172 22 13.114 22 15c0 1.886 0 2.828-.586 3.414C20.828 19 19.886 19 18 19h-1"
      />
    </svg>
  );
};
