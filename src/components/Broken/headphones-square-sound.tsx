  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M22 17v-5c0-4.714 0-7.071-1.465-8.536C19.072 2 16.714 2 12 2c-1.58 0-2.895 0-4 .055M2 17v-5c0-4.714 0-7.071 1.464-8.536A3.72 3.72 0 0 1 4 3.02M12 6.5v5M15 8v2M9 8v2"
      />
    </svg>
  );
};
